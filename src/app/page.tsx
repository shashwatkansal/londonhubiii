        ...
        <main className="min-h-screen bg-gray-50">
            ...
            >
                ...
                <div className="absolute inset-0">
                    <Image
                        src="/assets/images/london-skyline.jpg" // Use a high-quality image representing London
                        alt="London Skyline"
                        layout="fill"
                        objectFit="cover"
            ...
            <section className="relative py-32 bg-gradient-to-b from-blue-900 via-indigo-900 to-blue-900 overflow-hidden">
                ...
                >
                    ...
                    <p className="text-xl text-blue-100 mb-16 text-center max-w-4xl mx-auto">
                        Driving transformative change across London's diverse
                        communities through innovation, collaboration, and
                        dedication.
                    </p>
                        ...
                        {[
                            {
                                ...
                                icon: (
                                    <RiTeamFill className="w-16 h-16 text-blue-400" />
                                ),
                            },
                            {
                            ...
                            },
                            {
                                ...
                                icon: (
                                    <PiHandshakeFill className="w-16 h-16 text-purple-400" />
                                ),
                            },
                        ].map((stat, index) => (
                            <motion.div
            ...
            <section className="relative py-32 bg-gradient-to-b from-blue-900 via-indigo-900 to-blue-800 overflow-hidden">
                ...
                <div className="absolute inset-0">
                    ...
                    <div
                        ...
                        style={{
                            backgroundImage:
                                "url('/assets/patterns/circuit.svg')",
                        }}
                    ></div>
                </div>
                        ...
                        {[
                            {
                                ...
                                icon: (
                                    <RiEarthFill className="w-12 h-12 text-green-400" />
                                ),
                            ...
                            },
                            {
                                ...
                                icon: (
                                    <RiGovernmentFill className="w-12 h-12 text-blue-400" />
                                ),
                            ...
                            },
                            {
                                ...
                                icon: (
                                    <RiHandHeartFill className="w-12 h-12 text-orange-400" />
                                ),
                            ...
                            },
                            {
                                ...
                                icon: (
                                    <RiMentalHealthFill className="w-12 h-12 text-red-400" />
                                ),
                            ...
                            },
                            {
                                ...
                                icon: (
                                    <RiGroupFill className="w-12 h-12 text-purple-400" />
                                ),
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-12">
                        ...
                        <div className="lg:w-1/2">
                            ...
                            <p className="text-xl text-gray-700 mb-8">
                                ...
                                for our city. From diverse backgrounds and
                                expertise, our team brings innovative solutions
                                to London's most pressing challenges.
                            </p>
                            <Link href="/shapers">
                                <motion.button
                                    whileHover={{ scale: 1.05 }}
